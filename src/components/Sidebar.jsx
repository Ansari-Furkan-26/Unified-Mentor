            ...
            <ul className="mt-3">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex shrink-0 ml-2">
                            <svg className={`w-3 h-3 shrink-0 ml-1 fill-current text-gray-600 ${open && "rotate-180"}`} viewBox="0 0 12 12">
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/home"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " + (isActive ? "text-violet-500" : "text-gray-400/90 hover:text-gray-700 ")
                              }
                            >
                    ...
                    <React.Fragment>
                      <a
                        ...
                        className={`block text-gray-800 dark:text-gray-800 truncate transition duration-150 ${
                          pathname.includes("Menu") ? "" : "hover:text-gray-900"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
              ...
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] ${pathname.includes("calendar") && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}>
                <NavLink
                  ...
                  to="/event-schedule"
                  className={`block text-gray-800 truncate transition duration-150 ${
                    pathname.includes("calendar") ? "" : "hover:text-gray-900"
                  }`}
                >
                  <div className="flex items-center">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 truncate transition duration-150 ${open ? "" : "hover:text-gray-600 "}`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
                          setSidebarExpanded(true);
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/reset-password" className="text-gray-400 hover:text-gray-600 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                              Reset Password
                              </span>
                            </NavLink>
